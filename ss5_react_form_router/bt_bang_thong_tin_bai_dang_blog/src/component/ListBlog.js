    ...
    return (
        <>
            ...
            <div className="text-center">
                <Link to={`/create`} type="button" className="btn btn-secondary mt-3 mb-3">Create New Blog</Link>
            </div>
                            ...
                            post.map((post, index) => (
                                <tr key={index}>
                                    ...
                                    <td className="text-left">
                                        <Link to={`/detail/${post.id}`} style={{textDecoration:"none", color:"blue"}}>{post.title}</Link>
                                    </td>
